...
const Home = () => {
  ...
  return (
  <div className="bg-slate-700 w-full lg:h-full p-2 sm:p-4">
    <div className="h-full w-full flex flex-col items-center justify-center text-center gap-3">
      <h1 className="text-3xl sm:text-5xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
